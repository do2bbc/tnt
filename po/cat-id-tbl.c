...
FileID   RX from   Nr  MsgID        Size     Holes RXrdy last RX  Fhead BBS", 54},
  ...
  {"\
AutoBIN-receive not successful !\r       Checksum: %d, Received Checksum: \
%d\r       Total time: %d seconds, Transfer rate: %d Baud", 91},
  {"\
...
Total time: %d seconds, Transfer rate: %d Baud", 93},
  {"\
AutoBIN-receive finished\rFilename: %s\rChecksum: %d, Received Checksum: \
%d\rTotal time: %d seconds, Transfer rate: %d Baud", 94},
  {"ERROR: ", 95},
  {" not found", 96},
